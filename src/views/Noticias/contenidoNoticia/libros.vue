...
<menu-navegacion/>
  ...
  <div class="total">
    ...
    <div class="texto1">
      <documentos :documentos="noticia" :titulo="documentost" />
    </div>
    <div class="redes">
      <redes :redes="redes" />
    </div>
...
export default {
  data() {
    return {
      titulos: {
        Titulo1: "Libros para el Curso 2021-22",
        Titulo2: "Listado de ISBN",
      },
      redes: [
        {
  ...
  components: { Titulo, Redes, PiePagina, Documentos, MenuNavegacion},
  mounted() {
    window.scrollTo(0, 0);
  },
};
