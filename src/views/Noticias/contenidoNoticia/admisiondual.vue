...
import foto10 from "/src/assets/noticias/2021/06/fp-online.jpg";
...
export default {
  data() {
    return {
      ...
      noticia: {
        img:foto10,alt:"Admision FP",
        Texto1:"Publicamos un enlace que contiene un documento PDF con instrucciones sobre la admisión en FP para este curso 2021/22",
        Texto2:"",
        Texto3:"",
