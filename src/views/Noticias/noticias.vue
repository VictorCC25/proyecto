...
export default {
  data() {
    return {
      titulos: {
        Titulo1: "NOTICIAS",
        Titulo2: "Listado de noticias de Salesianos de Villamuriel",
      },
      redes: [
        {
      ...
      noticias: [
        {
          img: "/src/assets/img/noticias/2022/03/admisiones-ESO.jpeg",
          alt: "Admisiones",
        ...
        {img:"/src/assets/img/noticias/2022/03/video-excelencia.jpg",alt:"Video Excelencia",titulo:"Centro de Excelencia Profesional",
        ...
        {img:"/src/assets/img/noticias/2022/03/puertas-abiertas.jpg",alt:"Puertas abiertas",titulo:"Jornada de puertas abiertas para ESO",
        ...
        {img:"/src/assets/img/noticias/2021/12/listado-definitivo.jpg",alt:"ListadoFP",titulo:"Listado definitivo de candidatos en FP Dual",
        ...
        {img:"/src/assets/img/noticias/2021/11/listado-fpdual-blur.jpg",alt:"EmpresasFP",titulo:"Listado de empresas de la FP Dual",
        ...
        {img:"/src/assets/img/noticias/2021/10/info-fpdual-blur.jpg",alt:"InfoFP",titulo:"Información de ayuda para la FP Dual",
        texto1:"Información para familias",
        texto2:"Documento con toda la información sobre la FP Dual para el curso 2021/22",
        link:"/noticias/informaciondual"
        },
        {img:"/src/assets/img/noticias/2021/09/inicio-curso-blur.jpg",alt:"Inicio Curso",titulo:"Incio de curso 2021/22",
        ...
        {img:"/src/assets/img/noticias/2021/06/fp-online.jpg",alt:"Plazo adimsion",titulo:"Nuevo plazo de admisión en ciclos de FP: del 07 al 10 de Septiembre",
        ...
        {img:"/src/assets/img/noticias/2021/06/evaluacion.jpg",alt:"Video Evaluacion",titulo:"Vídeo: La evaluación como instrumento de aprendizaje",
        ...
        {img:"/src/assets/img/noticias/2021/06/fp-dual-video.jpg",alt:"Video FP Dual",titulo:"Vídeo: FP Dual en Telecomunicaciones e Informática",
        texto1:"Matrícula 2021/22",
        texto2:"Los alumnos de telecomunicaciones comentan si experiencia cursando la FP Dual",
        link:"/noticias/dual-teleco"
        },
        {img:"/src/assets/img/noticias/2021/06/fp-online.jpg",alt:"Admision FP",titulo:"Instrucciones para la admisión de FP",
        texto1:"Matrícula 2021/22",
        texto2:"Instrucciones para la admisión en FP en el Centro Salesianos Don Bosco para el curso 2021/22",
        link:"/noticias/admisiondual"
        },
        {img:"/src/assets/img/noticias/2021/06/premio-vmware.jpg",alt:"Premio VMWare",titulo:"Premio al mejor  centro VMWare IT Academy 2020",
        ...
        {img:"/src/assets/img/noticias/2021/06/Autoridades.jpg",alt:"Autoridades",titulo:"Presentación de Proyectos de ASIR",
        ...
        texto1:"Junio dec 2021",
        texto2:"Calendario de Éxamenes Finales para los alumnos y alumnas de 2º de ASIR para la convocatoria de Junio de 2021",
        link:"/noticias/finales-junio"
        },
        {titulo:"Libros para el curso 2021-22",
        texto1:"Listado de ISBN",
        texto2:"Ya están disponibles los libros para el curso que viene",
        link:"/noticias/libros"
        },
        {img:"/src/assets/img/noticias/2021/03/eso-puertas-abiertas.jpg",alt:"Puertas abiertas",titulo:"Jornada de Puertas abiertas",
        ...
        texto1:"Proyecto de secundaria",
        texto2:"Nuestr@s chic@s de 1º ESO nos explican y ejemplifican algunas de las funciones de la literatura utilizando la herremienta Croma",
        link:"/noticias/literatura"
        },
        {titulo:"FP Dual en nuestros Ciclos de Grado Medio",
        texto1:"Escuela Empresa",
        ...
        {img:"/src/assets/img/noticias/2021/01/heroes.jpg",alt:"Heroes",titulo:"Se buscan héroes",
        texto1:"",
        ...
        {img:"/src/assets/img/noticias/2020/11/FP_excelencia.jpeg",alt:"Excelencia FP",titulo:"Somos centro de excelencia de alto nivel",
        texto1:"",
  ...
  components: { Titulo, Redes, PiePagina, Noticia, MenuNavegacion},
  mounted() {
    window.scrollTo(0, 0);
  },
};
...
<style>
.fondonoticias {
  background-image: url("/src/assets/img/fondos/noticias.jpg");
